            ...
            >
              ...
              <div className="bg-gray-900/80 rounded-2xl p-6 md:p-8 shadow-xl mb-8 border border-gray-800">
                <div className="mb-8">
                  ...
                  <div className="border-2 border-dashed border-[#0ca2ed] rounded-lg p-8 text-center hover:border-[#0ca2ed] transition-colors cursor-pointer bg-gray-800/50">
                    <Input
                      type="file"
                      accept="image/*"
                      onChange={(e) => {
                    ...
                    <label htmlFor="designUpload" className="cursor-pointer">
                      <div className="flex flex-col items-center">
                        <div className="w-16 h-16 bg-[#0ca2ed]/20 rounded-full flex items-center justify-center mb-4 border border-[#0ca2ed]/40">
                        ...
                        <span className="text-[#0ca2ed] text-sm mt-1">SVG, PNG, JPG (max. 5MB)</span>
                      </div>
                    </label>
                      ...
                      <div className="mt-4">
                        <div className="relative w-32 h-32 mx-auto">
                          <img 
                            ...
                            alt="Preview" 
                            className="w-full h-full object-contain rounded-lg border border-[#0ca2ed]/30" 
                          />
                          <button 
                            onClick={() => {
                              productForm.setImagePreview(null);
                            }}
                            className="absolute -top-2 -right-2 bg-[#0ca2ed] text-white rounded-full p-1 hover:bg-[#0ca2ed]/80 transition-colors"
                          >
                ...
                <div className="relative flex items-center justify-center py-4">
                  ...
                  <span className="mx-4 flex-shrink-0 text-[#0ca2ed] text-lg font-medium">OR</span>
                  <div className="flex-grow border-t border-gray-600"></div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-gray-800 border-gray-700 text-white focus:ring-[#0ca2ed] focus:border-[#0ca2ed] placeholder:text-gray-500"
