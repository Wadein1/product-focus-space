      ...
      <div className="relative flex flex-col items-center justify-center w-full h-full">
        ...
        >
          ...
          <img 
            ...
            alt="Logo" 
            className={`w-32 md:w-48 absolute left-1/2 -translate-x-1/2 transition-all duration-700 ${
          ...
          <img 
            ...
            alt="Third Logo" 
            className={`w-[180px] md:w-[270px] absolute left-1/2 -translate-x-1/2 transition-all duration-700 ${
